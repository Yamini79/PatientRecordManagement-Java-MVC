...
<div id="primary">
		...
		<div><strong><a href="<%= request.getContextPath()%>/PatientHome.jsp" id="active">Home</a></strong></div>
					...
					<td width="20%">
				<div><strong><a href="<%= request.getContextPath()%>/FillHealthrecord.jsp" id="active">Fill Health Record</a></strong></div>
					</td>
					<td width="20%">
			<div><strong><a href="<%= request.getContextPath()%>/PatviewServlet" id="active">View Health Record</a></strong></div>
					</td>
					<td width="20%">
